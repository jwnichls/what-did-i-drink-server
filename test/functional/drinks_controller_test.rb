...
class DrinksControllerTest < ActionController::TestCase
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post :create, drink: { created_by: @drink.created_by, name: @drink.name, recipe: @drink.recipe, urls: @drink.urls }
    end
  ...
  test "should update drink" do
    put :update, id: @drink, drink: { created_by: @drink.created_by, name: @drink.name, recipe: @drink.recipe, urls: @drink.urls }
    assert_redirected_to drink_path(assigns(:drink))
  end
